...
export default function RoadQuizPart6() {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        // Load junctions data
        const junctionsResponse = await fetch('/junctions_part6.json');
        ...
        console.log(`Generated ${built.length} questions from ${entries.length} junction entries for Part 6`);
        setQuestions(built);
      } catch (e) {
        console.error(e);
      } finally {
  ...
  if (loading) {
    return (
      <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg text-center">Loading Road Quiz Part 6…</div>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-center mb-2">Road Quiz Part 6</h1>
